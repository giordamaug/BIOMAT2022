...
# ╔═╡ e96eb7dc-73fe-4b23-a097-285ee3565326
begin
	using CSV
	using DataFrames
	using GeometricFlux
...
# ╔═╡ abe88ad7-8321-468b-8cd9-59b86f724998
md"##Load the PPI network"

# ╔═╡ 5f162756-7887-11ed-1f5b-e5bf8faf1b16
df = CSV.File("/Users/maurizio/BIOMAT2022/KIDNEY/ppi.simple.csv") |> DataFrame

# ╔═╡ 6901ce42-c9fa-44c7-890c-b4b63cdb18aa
function do_edges(df)
...
# ╔═╡ 47087384-dcfb-4d79-9f06-3d2a3f936420
"
## Create Featured Graph from edge list
"

# ╔═╡ 28085d0f-128f-48dd-847d-27ac7b88cc4c
function create_fg(df)
	genes, idx = do_edges(df)
	g = Graphs.SimpleGraphs.SimpleGraph(length(genes))
	for i in 1:size(df)[1]
    	Graphs.SimpleGraphs.add_edge!(g, df[i, :edge][1], df[i, :edge][2])
	end
	return FeaturedGraph(g)
end

# ╔═╡ 511022d8-148b-479a-af7c-7fd07e2e5c39
md"""
Calculate embedding
"""

# ╔═╡ 7d238e5c-36fb-4cf2-99df-119c646fdc0a
vectors = node2vec(create_fg(df); walks_per_node=10, len=80, p=1.0, q=1.0)

# ╔═╡ b012a1f5-3b75-468a-b90d-57da4d2ac444
create_fg(df)
...
Node2Vec = "c775ef22-2988-11e9-03e2-6f3df0344398"
PlutoUI = "7f904dfe-b85e-4ff6-b463-dae2292396a8"

[compat]
CSV = "~0.10.8"
DataFrames = "~1.4.4"
GeometricFlux = "~0.13.7"
GraphSignals = "~0.7.3"
Graphs = "~1.7.4"
Node2Vec = "~0.1.0"
PlutoUI = "~0.7.49"
...
julia_version = "1.8.3"
manifest_format = "2.0"
project_hash = "548c164853c6d98319d64bdda7e0a1303bfc7f27"
...
git-tree-sha1 = "36f9e0632052ffc1e51a5074edd685d209ec2643"
...
[[deps.GraphSignals]]
deps = ["Adapt", "CUDA", "ChainRulesCore", "Distances", "FillArrays", "Functors", "Graphs", "LinearAlgebra", "MLUtils", "NNlib", "NNlibCUDA", "NearestNeighbors", "SimpleWeightedGraphs", "SparseArrays", "StatsBase"]
git-tree-sha1 = "cfc713e4d140f219a2e9740d29d17ff8827dcae3"
...
[[deps.Node2Vec]]
deps = ["DelimitedFiles", "LightGraphs", "Random", "SimpleWeightedGraphs", "TSne", "Test", "Word2Vec"]
git-tree-sha1 = "90d936ed2fea30145ba26541a78120ccf110be28"
uuid = "c775ef22-2988-11e9-03e2-6f3df0344398"
version = "0.1.0"
